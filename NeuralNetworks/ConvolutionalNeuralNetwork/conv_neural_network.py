...
# URL: https://pythonprogramming.net/convolutional-neural-network-cnn-machine-learning-tutorial/
# Youtube video: https://www.youtube.com/watch?v=7Wq-QmMT4gM&index=56&list=PLQVvvaa0QuDfKTOs3Keq_kaG2P55YRn5v
...
def train_conv_neural_network(x):

...
#
# Sentiment140 dataset is available from: http://help.sentiment140.com/for-students/
training_data = 'data/sentiment140/trainingandtestdata/training.1600000.processed.noemoticon.csv'
testing_data = 'data/sentiment140/trainingandtestdata/testdata.manual.2009.06.14.csv'
...
# convert the sentiment values of the dataset.
...
init_process(training_data,'train_set.csv')
init_process(testing_data,'test_set.csv')


# Create our lexicon. This is very similar to our method before, the only difference is that this lexicon is based on a
# random one out of every 2500 samples that we have, to get a random sampling.
